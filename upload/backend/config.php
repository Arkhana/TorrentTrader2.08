...
// Anti-Flood Settings
$site_config['floodsize']  = 1000;  // Maximum size of messages, forumposts, comments
$site_config['floodlimit'] = 10;    // Amount of sources before to be considered flood
$site_config['floodtime']  = 10;    // Time between messages, forumposts, comments
